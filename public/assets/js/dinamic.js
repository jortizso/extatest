...
function mostrarDetallesAnuncio(key, rectangle, verDetallesLink) {
    ...
    get(anuncioRef).then((snapshot) => {
        if (snapshot.exists()) {
            ...
            ID.innerHTML = `<span>ID:</span> <a target="_blank" href="../../../public/anuncio/${anuncio.codigoUnico}.html">${anuncio.codigoUnico}</a>`;
            ...
            const tarifaOriginal = parseFloat(anuncio.tarifa);
            const tarifaConAumento = tarifaOriginal * 1.066;  // Se le suma el 6.6%
            ...
            precio.innerHTML = `<span>Precio:</span> ${nuevoPrecio} Gs / hora`;
    ...
    <main>
        ...
        <div id="modalCompartir" class="modal">
            <div class="modal-content">
                ...
                <a href="https://api.whatsapp.com/send?text=Visita este anuncio: https://extasis.com.py/anuncios/${datosAnuncio.codigoUnico}"
    ...
    <footer class="footer">
        <section class="footer__container container">
            <nav class="nav nav--footer">
                ...
                <ul class="nav__link nav__link--footer">
                    ...
                    <li class="nav__items">
                        <a href="../legal/politica-de-comisiones-y-pagos.html" class="nav__links">Política de Comisiones y
                            Pagos</a>
                    </li>
                    <li class="nav__items">
        ...
        <section class="footer__copy container">
            <div class="footer__social">
                <a href="#" class="footer__icons"><img src="../assets/images/instagram.png" class="footer__img"></a>
                <a href="#" class="footer__icons"><img src="../assets/images/whatsapp.png" class="footer__img"></a>
                <a href="mailto:hola@extasis.com.py" class="footer__icons"><img src="../assets/images/telegram.png" class="footer__img"></a>
            </div>
